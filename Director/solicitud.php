...
if (isset($_SESSION['user_rut'])){
    if ($_SESSION["id_rol"] == '5'){
        ...
        echo"<script>alert('No estas autorizad@ para ingresar al perfil Director');</script>";
                    ...
                    <div class="modal-body">
                        <form>
                            <div class="form-group">
                                <label for="directorRecommend">¿Está Correcta la Solicitud?</label>
                                <select class="form-control" id="directorRecommend">
                            ...
                            <div class="form-group">
                                <label for="directorComment">Comentario</label>
                                <textarea class="form-control" name="directorComment" id="directorComment" placeholder="Ingrese Comentario (Opcional)"></textarea>
                            </div>
                        </form>
                    </div>
