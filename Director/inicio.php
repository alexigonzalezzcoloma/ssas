                ...
                <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                    ...
                    <ul class="nav navbar-nav flex-nowrap ml-auto">
                            ...
                            <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false" href="#"><span class="badge badge-danger badge-counter" id="numNotifications"></span><i class="fas fa-bell fa-fw"></i></a>
                                <div class="dropdown-menu dropdown-menu-right dropdown-list dropdown-menu-right animated--grow-in">
                                    ...
                                    <div id="notificationCenter">
                                        <div class="container" style="height: 300px;font-size: 11px;background-color: #fff;">
                                            <div class="center"><strong><h6>Aun no hay notificaciones</h6></strong></div>
                                        </div>
                                    </div>
          
                                    <!--<a class="text-center dropdown-item small text-gray-500" href="#">Mostrar todas</a>--></div>
                            </div>
                        </li>
                        <li class="nav-item dropdown no-arrow mx-1">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false" href="#"><span class="d-none d-lg-inline mr-2 text-gray-600 small"><?php echo $userName;?> - Director</span></a>
