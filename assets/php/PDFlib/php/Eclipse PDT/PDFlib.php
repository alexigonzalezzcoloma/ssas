 ...
 *
 * @return bool  -1 (in PHP: 0) on error, and 1 otherwise.
 */
 ...
 * Get the name of the API function which threw the last exception or failed.
 *
 * @return string  Name of an API function.
 */
function get_apiname() {}
 ...
 * @param int $idx
 * @param string $optlist
 * @return string  a string identified by a string index returned by another function.
 */
