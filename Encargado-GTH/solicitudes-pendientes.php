...
<head>
    ...
    <title>Solicitudes Pendientes GTH</title>
                    ...
                    <ul class="nav navbar-nav flex-nowrap ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <div class="nav-item dropdown no-arrow">
                                <a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false" href="#"><span class="d-none d-lg-inline mr-2 text-gray-600 small"><?php echo $userName;?> - Encargad@ GTH</span></a>
                        ...
                        <div class="table-responsive table-bordered table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info" style="font-size: 11px;height: auto;width: auto;">
                                        <table class="table table-striped table-bordered dataTable my-0" id="dataTable">
                                            ...
                                            <?php
                                                ...
                                                INNER JOIN estados on solicitudes.id_estado_actual=estados.id WHERE solicitudes.id_estado_actual = 7  and solicitudes.tipo='Contratos'";
