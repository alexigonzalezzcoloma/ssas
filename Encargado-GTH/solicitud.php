                    ...
                    <div class="modal-body">
                        <form>
                            <div class="form-group">
                                <label for="gthRecommend">¿Está Correcta la Solicitud?</label>
                                <select class="form-control" id="gthRecommend">
                            ...
                            <div class="form-group">
                                <label for="gthComment">Comentario</label>
                                <textarea class="form-control" name="gthComment" id="gthComment" placeholder="Ingrese Comentario (Opcional)"></textarea>
                            </div>
                        </form>
                    </div>
