<?php
    ...
    if (isset($_SESSION['user_rut'])){
        if ($_SESSION["id_rol"] == '7'){
            ...
            $gthRecommend=$_POST["gthRecommend"];
            $gthComment=$_POST["gthComment"];
            ...
            if($currentState==7 || $currentState==14 ){
                $sql_tiSend="INSERT INTO `movimientos` (`id_solicitud`, `rut_usuario`, `id_rol_usuario`, `id_estado`, `recomienda`, `comentario`, `fecha_hora`) VALUES ('$requestId', '$userRut', '$userRol', '8', '$gthRecommend', '$gthComment', '$date_time');";
                ...
                if($result_TISend){
                    ...
                    if ($result_nextState){
                        ...
                        echo "no se pudo guardar el segundo estado en el historial de solicitud";
                    }
                }else{
