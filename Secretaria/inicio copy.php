                                            ...
                                            <?php
                                                ...
                                                if (isset($_REQUEST['busqueda']) && isset($_REQUEST['estado'])){
                                                    ...
                                                    if($state==""){
                                                        ...
                                                        $sql1=$sql1." WHERE solicitudes.id_estado_actual='$state' and solicitudes.titulo LIKE '%$search%' or solicitudes.id_estado_actual='$state' and solicitudes.id='$search'";
                                                    }
                                                }
                                                if (isset($_REQUEST['estado']) && !isset($_REQUEST['busqueda'])){
                                                    ...
                                                    if($state==""){
                                                        $what_search='';
                                                        $sql1=$sql1." WHERE solicitudes.id_estado_actual>=4 and solicitudes.id_estado_actual<=13 or solicitudes.id_estado_actual < 4 and solicitudes.rbd_colegio='$schoolRbd'";
                                                    }else{
                                                        $what_search='estado='.$state;
                                                        $sql1=$sql1." WHERE solicitudes.id_estado_actual='$state' ";
                                                    }
                                                }
                                                if (!isset($_REQUEST['estado']) && isset($_REQUEST['busqueda'])){
                                                    $search=$_REQUEST["busqueda"];
