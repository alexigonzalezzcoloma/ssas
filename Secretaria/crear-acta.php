...
if (isset($_SESSION['user_rut'])){
   if ($_SESSION["id_rol"] == '9'){
      ...
      for ($i=0;$i<$num_req;$i++){
         ...
         if ($reqType=="Contratos"){
            ...
            if($num_rows_req>0){
               ...
               $pdf->Cell(28,6,utf8_decode('VALOR TOTAL'),1,1,'C');
               
               $pdf->SetFont('Times','',10);
               $pdf->SetWidths(Array(58,22,22,28,28));
      ...
      if($isRecord==1){
         ...
         $pdf->Ln(60);
         $pdf->Image($PresidentFirm,20,150,60,30);
         $pdf->Image($SecretaryFirm,135,160,60,30);
      ...
      echo"<script>alert('No estas autorizad@ para ingresar al perfil Secretaria');</script>";
