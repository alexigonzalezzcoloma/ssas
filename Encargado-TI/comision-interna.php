        ...
        <div class="d-flex flex-column" id="content-wrapper">
                    ...
                    <ul class="nav navbar-nav flex-nowrap ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <div class="nav-item dropdown no-arrow">
                                <a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false" href="#"><span class="d-none d-lg-inline mr-2 text-gray-600 small"><?php echo $userName;?> - Encargado/a GTH</span></a>
            ...
            <div class="container-fluid" style="margin: 0px;">
                <div class="card shadow">
                    <div class="card-header py-3"><strong>Agenda Comisión Interna</strong>
                    </div>
                                <div class="card-body">
                                    <!--<div class="container">
                                    ...
                                    <div class="table-responsive table-bordered table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info" style="font-size: 11px;height: auto;width: auto;">
                                        <table class="table table-striped table-bordered dataTable my-0" id="dataTable">
                                            ...
                                            <?php
                                                ...
                                                $sql1=$sql1." ORDER BY solicitudes.tipo DESC, solicitudes.id ASC ";
                                                ...
                                                if($num_rows_sql2>0){
                                                    while ($row=mysqli_fetch_array($result2)){
                                                        ...
                                                        <tr>
                                                            <td><?php echo $row["id"];?> <input name="reqid[]" value="<?php echo $row["id"];?>" hidden></td>
                                        ...
                                        <button type="submit" class="btn btn-warning" style="margin: 0px;padding: 0px;height: 29px;width: 103px;" name="preComission">Agenda</button>
                                        </form>
                                        <?php
                                        }
                                        ?>
            ...
            <div class="modal fade" role="dialog" tabindex="-1" id="genRecord">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p>Está Seguro de Generar Acta  
                                
                            ?&nbsp; &nbsp;Los Reportes detallados consumen muchos recursos del Servidor, sólo se recomiendan para Actas.</p>
                        </div>
