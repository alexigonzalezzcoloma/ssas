...
<head>
    ...
    <title>Solicitudes Pendientes - Editores</title>
                        ...
                        <div class="table-responsive table-bordered table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info" style="font-size: 11px;height: auto;width: auto;">
                                        <table class="table table-striped table-bordered dataTable my-0" id="dataTable">
                                            ...
                                            <?php
                                                ...
                                                INNER JOIN estados on solicitudes.id_estado_actual=estados.id WHERE solicitudes.id_estado_actual = 1 and solicitudes.rbd_colegio='$schoolRbd' ";
                                                ...
                                                if($num_rows_sql2>0){
                                                    while ($row=mysqli_fetch_array($result2)){
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo number_format($row["precio_total"],0,',','.')?></td>                                                            <td><?php echo $row["estado_actual"];?></td>
