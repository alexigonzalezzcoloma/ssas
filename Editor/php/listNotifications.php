...
if(isset($_SESSION['user_rut'])){
    ...
    $queryList="SELECT id, id_solicitud, mensaje FROM `notificaciones`, DATE_FORMAT(fecha_hora , '%d-%m-%Y %T')fecha where rbd_colegio='$schoolRbd' and id_destinatario='$rolId';";
