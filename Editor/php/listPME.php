    ...
    if (isset($_SESSION['user_rut'])){
        if ($_SESSION["id_rol"] == '4'){
            if(isset($_POST["requestId"])){
                ...
                pme_solicitudes.id_subdimension,pme_solicitudes.id_accion,pme_solicitudes.id_solicitud,
                ...
                acciones_pme.descripcion FROM `pme_solicitudes` 
                ...
                echo "no se detecta el id de la solicitud";
            }
        }else{
