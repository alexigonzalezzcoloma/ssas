        ...
        if ($_SESSION["id_rol"] == '4'){
            ...
            for($i=0;$i<$num_subs;$i++){
                ...
                if($result1){
                    ...
                    LEFT JOIN solicitudes ON solicitudes.id = requerimientos.id_solicitud  WHERE solicitudes.id_estado_actual>3 and solicitudes.id_estado_actual!=14 and solicitudes.id_estado_actual!=16 and solicitudes.rbd_colegio='$schoolRbd' and requerimientos.id_subvencion='$subsGroup[$i]' and solicitudes.fecha_hora BETWEEN '$startDate' and '$endDate';";
                    $result2=mysqli_query($connection,$sql2);
                    if($result2){
                        $sql3="SELECT SUM(precio*cantidad) as presupuesto_gestion FROM `requerimientos` WHERE id_solicitud='$requestId' and requerimientos.id_subvencion='$subsGroup[$i]';";
