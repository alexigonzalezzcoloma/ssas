        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background-color: rgb(0,50,100);">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <li class="nav-item"><a class="nav-link" href="inicio.php"><i class="fas fa-tachometer-alt"></i><span>Mi Bandeja</span></a></li>
                    ...
                    <li class="nav-item"><a class="nav-link active" href="comision-interna.php"><i class="fas fa-comment-slash"></i><span>Comisiones Internas</span></a></li>
                    ...
                    <ul class="nav navbar-nav flex-nowrap ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <div class="nav-item dropdown no-arrow">
                                <a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false" href="#"><span class="d-none d-lg-inline mr-2 text-gray-600 small"><?php echo $userName;?> - Editor/a</span></a>
            ...
            <div class="container-fluid" style="margin: 0px;">
                ...
                <div class="card shadow" >
                    ...
                    <div class="card-header py-3">
                        <strong>Historial de Comisiones</strong>
                    </div>
