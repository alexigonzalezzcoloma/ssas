...
if (isset($_SESSION['user_rut'])){
    if ($_SESSION["id_rol"] == '4'){
        if (isset($_REQUEST["numero"])){
            ...
            $sql_verifySchool="SELECT COUNT(solicitudes.id) FROM solicitudes WHERE solicitudes.id='$numero' AND rbd_colegio='$schoolRbd';";
            $result_verifySchool=mysqli_query($connection,$sql_verifySchool);
            $row_verifySchool=mysqli_fetch_row($result_verifySchool);
            $verifySchool=$row_verifySchool[0];
            if ($verifySchool == '1'){
                $schoolRbd=$_SESSION['rbd_colegio'];
        ...
        echo"<script>alert('No estas autorizad@ para ingresar al perfil Editor');</script>";
            ...
            <div id="content">
                <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                    <div class="container-fluid">
                        <label for="">Solicitud: <?php echo $numero; ?></label>
                    ...
                    <ul class="nav navbar-nav flex-nowrap ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <div class="nav-item dropdown no-arrow">
                                <a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false" href="#"><span class="d-none d-lg-inline mr-2 text-gray-600 small"><?php echo $userName;?> - Editor</span></a>
            ...
            <div class="container-fluid">
                ...
                <div class="col">
                    ...
                    <div class="container-fluid my-4">
                        <button class="btn btn-success" type="button" onclick="sendRequest('<?php echo $numero; ?>')">Enviar Solicitud</button>
                        <button class="btn btn-warning" type="button" onclick="chargeSubventions('subSpecialReq')" data-toggle="modal" data-target="#specialReqModal">Enviar Solicitud Especial</button>
                    </div>
        ...
        <div class="modal fade" id="specialReqModal" role="dialog" tabindex="-1">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <p>Opción para enviar solicitudes de permisos sin goce de sueldo, Bonos, Bono Sala Cuna, si no es un tipo de estas solicitudes súbala de la manera normal;</p>
                        <div class="form-group">
                            <label>Ingrese el Precio acá</label>
                            <input type="text" class="form-control" id="totalPrice"/>
                            <label for="">Ingrese la Subvención a la que desea cargar el monto</label>
