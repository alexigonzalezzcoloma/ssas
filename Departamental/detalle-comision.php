        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="col">
                    ...
                    <div class="card shadow mb-3">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 font-weight-bold">Resumen CIE</p>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive table-bordered table mt-2" id="dataTable-1" role="grid" aria-describedby="dataTable_info" style="font-size: 14px;height: auto;width: auto;">
                                ...
                                <br><br><h5>Resumen de Gastos</h5><br>
                                <table class="table table-striped table-bordered dataTable my-0" id="dataTable">
                                    <thead>
                                        <tr>
                                            <th>Colegio</th>
