            ...
            <div class="container-fluid">
                ...
                <div class="col">
                    ...
                    <div class="container-fluid my-4">
                        ...
                        <?php 
                            if($currentState==1){
                                echo "<button class='btn btn-warning' type='button' onclick='sendRequestEditor($numero)'>Enviar a Revisión</button>";
                            } 
                        ?>
                        <button class="btn btn-success" type="button" data-toggle="modal" data-target="#sendReqModal">Enviar a Comisión</button>
