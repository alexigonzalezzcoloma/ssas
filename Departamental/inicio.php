...
<head>
    ...
    <title>Perfil Departamentales</title>
...
<body id="page-top">
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
                ...
                <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                    ...
                    <ul class="nav navbar-nav flex-nowrap ml-auto">
                        <li class="nav-item dropdown no-arrow mx-1">
                            <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false" href="#"><span class="badge badge-danger badge-counter" id="numNotifications"></span><i class="fas fa-bell fa-fw"></i></a>
            ...
            <?php
            $type="";
            if(!empty($_REQUEST['tipoSolicitud'])){
                $type = $_REQUEST['tipoSolicitud'];
            }
            ...
            <div class="container-fluid" style="margin: 0px;">
                <div class="card shadow">
                    ...
                    <a class="btn btn-secondary btn-sm" role="button" style="margin: 0px;padding: 0px;height: 29px;width: 103px;" onclick="sendAllRequest()">Todas a Age.</a>
                    </div>
                    ...
                    <div class="card-body">
                        <!--<div class="container">
                            <div class="row">
                                <div class="col">
                                    <label class="" for="">Tipo de Solicitud</label><br>
                                ...
                                <div class="col">
                                    <button class="btn btn-success my-4" type="button" style="width: 73px;font-size: 12px;">Filtrar</button>
                                    <button class="btn btn-danger my-4" type="button" style="width: 73px;font-size: 12px;">Quitar F.</button>
                                </div>
                            </div>
                        ...
                        <div class="table-responsive table-bordered table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info" style="font-size: 11px;height: auto;width: auto;">
                                        <table class="table table-striped table-bordered dataTable my-0" id="dataTable">
                                            ...
                                            <?php
                                                ...
                                                INNER JOIN estados on solicitudes.id_estado_actual=estados.id ";


                                                if (isset($_REQUEST['busqueda']) && isset($_REQUEST['tipoSolicitud'])){
                                                    ...
                                                    if($type==""){
                                                        ...
                                                        $what_search='busqueda='.$search.'&estado='.$type;
                                                        $sql1=$sql1." and solicitudes.id_estado_actual='$type' and solicitudes.titulo LIKE '%$search%' or solicitudes.id_estado_actual='$type' and solicitudes.id='$search'";
                                                    }
                                                }
                                                if (isset($_REQUEST['tipoSolicitud']) && !isset($_REQUEST['busqueda'])){
                                                    $type=$_REQUEST["estado"];
                                                    if($type==""){
                                                        $what_search='';
                                                        $sql1=$sql1;
                                                    }else{
                                                        $what_search='estado='.$type;
                                                        $sql1=$sql1." and solicitudes.id_estado_actual='$type' ";
                                                    }
                                                }
                                                ...
                                                if (isset($_REQUEST['busqueda'])){
                                                    $search=$_REQUEST["busqueda"];
                                                    $sql1=$sql1." WHERE solicitudes.titulo LIKE '%$search%' or solicitudes.id='$search'";
                                                }else{
                                                    $search="";
                                                    $sql1=$sql1. " WHERE solicitudes.id_estado_actual >= 4 and solicitudes.id_estado_actual<=11  
                                                    or solicitudes.id_estado_actual < 4 and solicitudes.rbd_colegio='$schoolRbd'";
                                                }
                                                ...
                                                if($num_rows_sql2>0){
                                                    while ($row=mysqli_fetch_array($result2)){
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a class="btn btn-success btn-circle ml-1" role="button" style="font-size: 11px;width: 30px;height: 30px;margin: -8px;" href="solicitud.php?numero=<?php echo $row["id"];?>"><i class="far fa-eye text-white"></i></a>
                                                                <a class="btn btn-danger btn-circle ml-1" role="button" style="font-size: 11px;width: 30px;height: 30px;margin: -8px;" <?php echo $row["id"];?>>X<i class="fa fa-trash-o text-white"></i></a>
                                                            </td>
                                                        </tr>
                                                <?php
                                                    }
