    ...
    if (isset($_SESSION['user_rut'])){
        if ($_SESSION["id_rol"] == '2'){
            ...
            for($i=0;$i<$num_subs;$i++){
                $sql1="SELECT presupuestos_subvenciones.monto as presupuesto_subvencion FROM `presupuestos_subvenciones` 
                WHERE presupuestos_subvenciones.rbd_colegio='$schoolRbd' and presupuestos_subvenciones.id_subvencion='$subsGroup[$i]' 
                and fecha_fin BETWEEN '$startDate' and '$endDate';";
                ...
                if($result1){
                    ...
                    WHERE id_estado_actual >'3' and id_estado_actual!='14' and solicitudes.id_estado_actual!='16' and solicitudes.rbd_colegio='$schoolRbd' 
